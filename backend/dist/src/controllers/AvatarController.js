...
var ImageController = /** @class */ (function () {
    ...
    ImageController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var token, user_id, _a, name, size, key, _b, avatar_url, user, userId;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        token = req.headers.authorization;
                        user_id = req.headers.userid;
                        _a = req.file, name = _a.originalname, size = _a.size, key = _a.key, _b = _a.location, avatar_url = _b === void 0 ? '' : _b;
                        if (!user_id) {
                            return [2 /*return*/, res.status(400).json({ err: 'Não Permitido ' })];
                        }
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection_1.default('user_avatar').insert({
                                id: uuid_1.v4(),
                                user_id: user_id,
